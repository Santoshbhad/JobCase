...
This package contains:
   ...
   Magnolia Core 5.4.3
   Magnolia Internationalization Framework 5.4.3
   Magnolia Imaging Support Module 3.2.3
   Magnolia JAAS 5.4.3
   Magnolia Imaging Module 3.2.3
   Magnolia Rendering 5.4.3
   Magnolia Templating 5.4.3
   Magnolia Templating for JSP 5.4.3
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.4.3.html
